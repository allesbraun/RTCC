...
predictor = TabularPredictor(label='efficiency').fit(train_data_efficiency, presets=['medium_quality'])
predictor = TabularPredictor(label='complexity_class').fit(train_data_class, presets=['medium_quality'])
